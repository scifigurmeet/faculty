                                  ...
                                  <thead>
                                      ...
                                      <tbody>
                                          ...
                                          <td><input type="text" value="<?php echo $rows['participation']; ?>" disabled style="background: none;" class="participation_<?php echo $j; ?>" name="participation"></td>
                                                  <td><input type="text" value="<?php echo $rows['duration_from']; ?>" disabled style="background: none;" class="participation_<?php echo $j; ?>" name="duration_from"></td>
                                              <td><input type="text" value="<?php echo $rows['duration_to']; ?>" disabled style="background: none;" class="participation_<?php echo $j; ?>" name="duration_to"></td>
                                          ...
                                          <td><input type="text" value="<?php echo $rows['remarks']; ?>" disabled style="background: none;" class="participation_<?php echo $j; ?>" name="remarks"></td>
                                          <td><input type="text" value="<?php echo $rows['fac_id']; ?>" disabled style="background: none;" class="participation_<?php echo $j; ?>" name="fac_id"></td>
                                              <form method="post">
                                          ...
                                          <td><input type="text" style="background: none;" class="participation_<?php echo $j; ?>" name="participation_new"></td>
                                                  <td><input type="text" style="background: none;" class="participation_<?php echo $j; ?>" name="duration_from_new"></td>
                                                  <td><input type="text" style="background: none;" class="participation_<?php echo $j; ?>" name="duration_to_new"></td>
                                          ...
                                          <td><input type="text" style="background: none;" class="participation_<?php echo $j; ?>" name="remarks_new"></td>
                                          <td><input type="text" style="background: none;" class="participation_<?php echo $j; ?>" name="fac_id_new" value="<?php echo $_SESSION['id'];?>"></td>
                                              <td>
...
// PHD
    if(isset($_POST['update_btn'])) {
        ...
        if($result) {
            ...
            echo "<script>window.location = 'acivities_organised.php';</script>";
        }
        else {
    ...
    if(isset($_POST['insert_new'])) {
        ...
        $duration_from_new = $_POST['duration_from'];
        ...
        $sql = "INSERT INTO activities_organized (title, participation, duration_from, duration_to, institution, others, remarks, fac_id)
